...
It should only modify the values of Spacemacs settings."
  ...
  (setq-default
   ...
   dotspacemacs-startup-banner-scale
   'auto
...
If you are unsure, try setting them in `dotspacemacs/user-config' first."
  ...
  (setq-default spell-checking-enable-by-default
                nil))
...
This function is called at the very end of Spacemacs initialization."
  (custom-set-variables
   ...
   '(package-selected-packages '(company-web web-completion-data counsel-css
                                             counsel swiper ivy helm-css-scss impatient-mode
                                             pug-mode sass-mode haml-mode scss-mode slim-mode
                                             tagedit add-node-modules-path emmet-mode import-js
                                             grizzl typescript-mode web-mode csv-mode ac-ispell
                                             afternoon-theme alect-themes ample-theme ample-zen-theme
                                             anti-zenburn-theme apropospriate-theme auto-complete
                                             auto-dictionary auto-yasnippet badwolf-theme
                                             birds-of-paradise-plus-theme bubbleberry-theme
                                             busybee-theme cherry-blossom-theme chocolate-theme
                                             ...
                                             darktooth-theme django-theme doom-themes dracula-theme
                                             esh-help eshell-prompt-extras eshell-z espresso-theme
                                             evil-org exotica-theme eziam-themes farmhouse-themes
                                             flatland-theme flatui-theme flycheck-pos-tip
                                             pos-tip flyspell-correct-helm flyspell-correct
                                             fuzzy gandalf-theme gh-md git-link git-messenger
                                             git-modes git-timemachine gitignore-templates
                                             gnuplot gotham-theme grandshell-theme groovy-imports
                                             pcache groovy-mode gruber-darker-theme gruvbox-theme
                                             hc-zenburn-theme helm-c-yasnippet helm-company
                                             company helm-git-grep helm-ls-git helm-lsp
                                             helm-org-rifle hemisu-theme heroku-theme htmlize
                                             inkpot-theme ir-black-theme jazz-theme jbeans-theme
                                             kaolin-themes light-soap-theme lsp-java dap-mode
                                             lsp-docker bui lsp-origami origami lsp-treemacs
                                             lsp-ui lsp-mode lush-theme madhat2r-theme
                                             majapahit-themes markdown-toc material-theme
                                             maven-test-mode minimal-theme mmm-mode modus-themes
                                             moe-theme molokai-theme monochrome-theme monokai-theme
                                             multi-term multi-vterm xref mustang-theme
                                             mvn naquadah-theme noctilux-theme obsidian-theme
                                             occidental-theme oldlace-theme omtose-phellack-theme
                                             org-cliplink org-contrib org-download org-mime
                                             org-pomodoro alert log4e gntp org-present
                                             org-projectile org-project-capture org-category-capture
                                             org-rich-yank organic-green-theme orgit-forge
                                             orgit forge yaml markdown-mode ghub closql
                                             emacsql treepy org phoenix-dark-mono-theme
                                             phoenix-dark-pink-theme planet-theme professional-theme
                                             purple-haze-theme railscasts-theme rebecca-theme
                                             reverse-theme seti-theme shell-pop smeargle
                                             smyx-theme soft-charcoal-theme soft-morning-theme
                                             soft-stone-theme solarized-theme soothe-theme
                                             autothemer spacegray-theme subatomic-theme
                                             subatomic256-theme sublime-themes sunny-day-theme
                                             tango-2-theme tango-plus-theme tangotango-theme
                                             tao-theme terminal-here toxi-theme treemacs-magit
                                             magit seq magit-section git-commit with-editor
                                             transient twilight-anti-bright-theme twilight-bright-theme
                                             twilight-theme ujelly-theme underwater-theme
                                             vterm white-sand-theme xterm-color yaml-mode
                                             yasnippet-snippets yasnippet zen-and-art-theme
                                             zenburn-theme zonokai-emacs ace-jump-helm-line
                                             ...
                                             devdocs dired-quick-sort drag-stuff dumb-jump
                                             editorconfig elisp-def elisp-slime-nav emr
                                             clang-format list-utils eval-sexp-fu evil-anzu
                                             anzu evil-args evil-cleverparens paredit evil-collection
                                             annalist evil-easymotion evil-escape evil-exchange
                                             evil-goggles evil-iedit-state iedit evil-indent-plus
                                             ...
                                             helm-purpose helm-swoop helm-themes helm-xref
                                             helm wfnames helm-core hide-comnt highlight-indentation
                                             highlight-numbers parent-mode highlight-parentheses
                                             hl-todo compat hungry-delete indent-guide
                                             info+ inspector link-hint lorem-ipsum macrostep
                                             multi-line shut-up nameless open-junk-file
                                             org-superstar overseer f pkg-info epl paradox
                                             spinner password-generator popup popwin quickrun
                                             rainbow-delimiters request restart-emacs smartparens
                                             space-doc spaceline powerline spacemacs-purpose-popwin
                                             ...
                                             treemacs-persp persp-mode treemacs-projectile
                                             treemacs projectile cfrs ht pfuture ace-window
                                             avy posframe s undo-tree queue uuidgen vi-tilde-fringe
                                             vim-powerline volatile-highlights window-purpose
                                             imenu-list winum dash writeroom-mode visual-fill-column
                                             ws-butler async bind-map diminish dotenv-mode
                                             evil-evilified-state holy-mode hybrid-mode
                                             evil goto-chg hydra lv pcre2el use-package
                                             bind-key which-key)))
  (custom-set-faces
